...
st.text_input("Please enter the specific location name in the selected county")
st.selectbox('Have You noticed their color',('Brown', 'Yellow', 'Pink/Red','Black/Yellow','Yellow/Brown'))
